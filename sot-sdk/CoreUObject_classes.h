...
namespace CG
{
	...
	{
	public:
		static inline class TUObjectArray* GObjects = nullptr;                                                  // 0x0000(0x0008)
	...
	{
	public:
		unsigned char                                      UnknownData_KX53[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_7JVD[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                      pad_SC0291WTO3[0x40];                                      // 0x0048(0x0040) NOT AUTO-GENERATED PROPERTY
	...
	{
	public:
		unsigned char                                      UnknownData_XBC6[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_857Z[0x58];                                    // 0x0028(0x0058) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_BUVZ[0x138];                                   // 0x0088(0x0138) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                      pad_MLA1OPMION[0x04];                                      // 0x00AC(0x0004) NOT AUTO-GENERATED PROPERTY
		void* Func;                                                      // 0x00B0(0x0008) NOT AUTO-GENERATED PROPERTY
		unsigned char                                      pad_GIV6UU42OY[0x8];                                       // 0x00B8(0x0008) NOT AUTO-GENERATED PROPERTY
	...
	{
	public:
		unsigned char                                      UnknownData_ZC8F[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_0OD1[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_0P2P[0x28];                                    // 0x0030(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_YPHO[0x150];                                   // 0x01C0(0x0150) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_Q0Z0[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_ZX9X[0x150];                                   // 0x00B8(0x0150) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_6V6S[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_9Q3C[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_QJCD[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_ZPNE[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_HOFZ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		static UClass* StaticClass()
		{
			static auto ptr = UObject::FindClass(_xor_("Class CoreUObject.AssetObjectProperty"));
			return ptr;
		}
	};
	...
	{
	public:
		unsigned char                                      UnknownData_BLVR[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)

		static UClass* StaticClass()
		{
			static auto ptr = UObject::FindClass(_xor_("Class CoreUObject.AssetClassProperty"));
			return ptr;
		}
	};
	...
	{
	public:
		unsigned char                                      UnknownData_LICO[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_OFHB[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_CKIF[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_SV1J[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_V09O[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_MDZB[0x38];                                    // 0x0070(0x0038) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_MUTK[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                      UnknownData_RKWU[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
