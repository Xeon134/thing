...
namespace CG
{
	...
	{
		unsigned char                                      UnknownData_VT3S[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ED6Y[0x1];                                     // 0x0031(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_U9M6[0xD];                                     // 0x0033(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_3JHQ[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_3WHE[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_JC8N[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FHitResult
	{
		...
		unsigned char                                      UnknownData_NUU8[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FRepAttachment
	{
		...
		unsigned char                                      UnknownData_N3Y1[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_P5VD[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FRepMovement
	{
		...
		unsigned char                                      UnknownData_TLUR[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FRepRootMotionMontage
	{
		...
		unsigned char                                      UnknownData_Y1XX[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_GTEN[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (PADDING)
	};
	...
	struct FSimulatedRootMotionReplicatedMove
	{
		...
		unsigned char                                      UnknownData_W91X[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FRootMotionMovementParams
	{
		...
		unsigned char                                      UnknownData_Z22A[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              BlendWeight;                                               // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_WS5M[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FBasedMovementInfo
	{
		...
		unsigned char                                      UnknownData_LMS7[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimTickRecord
	{
		...
		unsigned char                                      UnknownData_52AW[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_WOZQ[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_9GVC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_KY77[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimNotifyEvent : public FAnimLinkableElement
	{
		...
		unsigned char                                      UnknownData_BGQC[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_AQDP[0x2];                                     // 0x009A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_DXPX[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_4OEU[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FPlayerAmbientLightOverrideSettings
	{
		...
		unsigned char                                      UnknownData_OB8E[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_PUE1[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FWeightedBlendable
	{
		...
		unsigned char                                      UnknownData_W26R[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FRainPostProcessSettings
	{
		...
		unsigned char                                      UnknownData_5M7K[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_YLZX[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_BTVJ[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FLPVCascadeSettings
	{
		...
		unsigned char                                      UnknownData_NKVC[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_9W92[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FPostProcessSettings
	{
		...
		unsigned char                                      UnknownData_HIPW[0x1];                                     // 0x0013(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_O9X6[0x3];                                     // 0x02F1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_NY21[0x3];                                     // 0x0339(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_Y8OV[0x4];                                     // 0x037C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_XKZ5[0x3];                                     // 0x0389(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_S49A[0x3];                                     // 0x03E1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_CIDS[0x3];                                     // 0x03FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_SFNJ[0x3];                                     // 0x0515(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_N7Z5[0x8];                                     // 0x0538(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FMinimalViewInfo
	{
		...
		unsigned char                                      UnknownData_D9XF[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_MZQG[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_QAX5[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_631L[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FPostProcessSettings                        PostProcessSettings;                                       // 0x0050(0x0540) (BlueprintVisible)
		unsigned char                                      UnknownData_ASRH[0x10];                                    // 0x0590(0x0010) MISSED OFFSET (PADDING)
	};
	...
	struct FMovementProperties
	{
		...
		unsigned char                                      UnknownData_YKH6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FNavAgentProperties : public FMovementProperties
	{
		...
		unsigned char                                      UnknownData_1ALG[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_2UZW[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FClassRedirect
	{
		...
		unsigned char                                      UnknownData_SDT4[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FResponseChannel
	{
		...
		unsigned char                                      UnknownData_E2T2[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FWalkableSlopeOverride
	{
		...
		unsigned char                                      UnknownData_G1SV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_YID2[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVector                                     Scale3D;                                                   // 0x0004(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_7XB3[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FName                                       CollisionProfileName;                                      // 0x0014(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_N3A8[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_MQ73 : 1;                                      // 0x0050(0x0001) BIT_FIELD (PADDING)
		...
		unsigned char                                      UnknownData_SG9Y : 1;                                      // 0x0052(0x0001) BIT_FIELD (PADDING)
		...
		unsigned char                                      UnknownData_TB8Z[0x1];                                     // 0x0053(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_J2PB[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_8HRI[0x37];                                    // 0x00C9(0x0037) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_GA30[0x68];                                    // 0x0114(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_XNJZ[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FOverlapInfo
	{
		unsigned char                                      UnknownData_05NF[0x84];                                    // 0x0000(0x0084) MISSED OFFSET (PADDING)
	};
	...
	struct FDebugDisplayProperty
	{
		...
		unsigned char                                      UnknownData_NIJT[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
	};
	...
	struct FNavAgentSelector
	{
		...
		unsigned char                                      UnknownData_UKIB[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
	};
	...
	struct FNavigationLinkBase
	{
		...
		unsigned char                                      UnknownData_9UOG[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_WP67[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_B995[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_CVQU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	struct FSkeletalMaterial
	{
		...
		unsigned char                                      UnknownData_WQED[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FBoneMirrorInfo
	{
		...
		unsigned char                                      UnknownData_N67R[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FTriangleSortSettings
	{
		...
		unsigned char                                      UnknownData_NDFU[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FBoneReference
	{
		...
		unsigned char                                      UnknownData_C04B[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FSimplygonChannelCastingSettings
	{
		...
		unsigned char                                      UnknownData_SK39[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FClothingAssetData
	{
		...
		unsigned char                                      UnknownData_K2I8[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_5UV3[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
	};
	...
	struct FSingleAnimationPlayData
	{
		...
		unsigned char                                      UnknownData_M0AT[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_EU5C[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_SGAP[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FName                                       LastObservedName;                                          // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_TL54[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_LQZJ[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_V0KR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FRichCurveKey
	{
		...
		unsigned char                                      UnknownData_6XBZ[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FRichCurve : public FIndexedCurve
	{
		...
		unsigned char                                      UnknownData_C6M9[0x6];                                     // 0x005A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_IETH[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FCompositeSection : public FAnimLinkableElement
	{
		...
		unsigned char                                      UnknownData_38C6[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimSegment
	{
		...
		unsigned char                                      UnknownData_EJT7[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FBranchingPointMarker
	{
		...
		unsigned char                                      UnknownData_VD9G[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FTimerHandle
	{
		unsigned char                                      UnknownData_LPRT[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FDebugFloatHistory
	{
		...
		unsigned char                                      UnknownData_K41E[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FFormatTextArgument
	{
		...
		unsigned char                                      UnknownData_VSTY[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		struct FText                                       TextValue;                                                 // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit, BlueprintVisible, DisableEditOnTemplate)
		unsigned char                                      UnknownData_S2TR[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	};
	...
	struct FBakedStateExitTransition
	{
		...
		unsigned char                                      UnknownData_ISZW[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimationTransitionBetweenStates : public FAnimationStateBase
	{
		...
		unsigned char                                      UnknownData_NCFY[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ZACV[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FKShapeElem
	{
		unsigned char                                      UnknownData_4IJM[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
	};
	...
	struct FFindFloorResult
	{
		...
		unsigned char                                      UnknownData_FQOW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FParticleBurst
	{
		...
		unsigned char                                      UnknownData_TOAY[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FRotationAboutAxisParameters
	{
		...
		unsigned char                                      UnknownData_2DPK[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FStatColorMapping
	{
		...
		unsigned char                                      UnknownData_A0C1[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FOrbitOptions
	{
		...
		unsigned char                                      UnknownData_ZDZR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FSoundGroup
	{
		...
		unsigned char                                      UnknownData_B6W1[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_TNOH[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FTViewTarget
	{
		...
		unsigned char                                      UnknownData_20T7[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ST7Q[0x8];                                     // 0x05B8(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_B11G[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
	};
	...
	struct FActiveForceFeedbackEffect
	{
		...
		unsigned char                                      UnknownData_8Z9Z[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
	};
	...
	struct FViewTargetTransitionParams
	{
		...
		unsigned char                                      UnknownData_QCVH[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_5WTR[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FLevelStreamingStatusUpdateInfo
	{
		...
		unsigned char                                      UnknownData_DGO3[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FLightmassWorldInfoSettings
	{
		...
		unsigned char                                      UnknownData_V5PD[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_AY43[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_59KE[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FReverbSettings
	{
		...
		unsigned char                                      UnknownData_7X0B[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_55Z6[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FInteriorSettings
	{
		...
		unsigned char                                      UnknownData_BQU2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FLightmassMaterialInterfaceSettings
	{
		...
		unsigned char                                      UnknownData_K1SV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_TNG4[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FMaterialInput
	{
		...
		unsigned char                                      UnknownData_TJP4[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FScalarMaterialInput : public FMaterialInput
	{
		...
		unsigned char                                      UnknownData_PD1P[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD (NoDestructor)
		unsigned char                                      UnknownData_BMVY[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_YLSN[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FExpressionInput
	{
		class UMaterialExpression* Expression;                                                // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		int                                                OutputIndex;                                               // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_WRWE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FString                                     InputName;                                                 // 0x0010(0x0010) (ZeroConstructor, HasGetValueTypeHash)
		int                                                Mask;                                                      // 0x0020(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		int                                                MaskR;                                                     // 0x0024(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		int                                                MaskG;                                                     // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FDistributionLookupTable
	{
		...
		unsigned char                                      UnknownData_48CY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_6J4D[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FBeamModifierOptions
	{
		...
		unsigned char                                      UnknownData_HGM4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FInstancedNavMesh
	{
		...
		unsigned char                                      UnknownData_UEBI[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FAudioQualitySettings
	{
		...
		unsigned char                                      UnknownData_OFBO[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		int                                                MaxChannels;                                               // 0x0038(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_1HQE[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FExpressionOutput
	{
		...
		unsigned char                                      UnknownData_LD8K[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FExposedValueCopyRecord
	{
		...
		unsigned char                                      UnknownData_MV58[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_5G0R[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_IIEM[0x20];                                    // 0x0050(0x0020) MISSED OFFSET (PADDING)
	};
	...
	struct FExposedValueHandler
	{
		...
		unsigned char                                      UnknownData_1OW0[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_2YWZ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FPoseLinkBase
	{
		...
		unsigned char                                      UnknownData_857S[0x14];                                    // 0x0004(0x0014) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_SaveCachedPose : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_V8VT[0x40];                                    // 0x0050(0x0040) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_AssetPlayerBase : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_RJ6J[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_TCNP[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
	{
		...
		unsigned char                                      UnknownData_MDEC[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
	{
		...
		unsigned char                                      UnknownData_6JCQ[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_7XAY[0xB];                                     // 0x0055(0x000B) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_Slot : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_KU0L[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_HHOU[0x6];                                     // 0x005A(0x0006) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_StateMachine : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_R0NJ[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_T67G[0x60];                                    // 0x0048(0x0060) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_MTPX[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_F45L[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_TransitionPoseEvaluator : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_HKLF[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ZTUG[0x40];                                    // 0x0038(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int                                                CacheFramesRemaining;                                      // 0x0078(0x0004) (ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_626A[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_TransitionResult : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_N30G[0xF];                                     // 0x0031(0x000F) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimationNode_TwoWayBlend : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_U8PX[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FCameraCacheEntry
	{
		...
		unsigned char                                      UnknownData_ZP2G[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAttenuationSettings
	{
		...
		unsigned char                                      UnknownData_MQXW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_2EOF[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_B46O[0x2];                                     // 0x008A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_S77Q[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_B3CJ[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FParticleEventGPU_GenerateInfo
	{
		...
		unsigned char                                      UnknownData_1GAP[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_PKUP[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FFuncStatEntry
	{
		...
		unsigned char                                      UnknownData_L6M9[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FSpikeStatEntry
	{
		...
		unsigned char                                      UnknownData_RUYN[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_6YJG[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_IH2F[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_8EG6[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
	...
	struct FAutoCompleteNode
	{
		...
		unsigned char                                      UnknownData_GXJP[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<int>                                        AutoCompleteListIndices;                                   // 0x0008(0x0010) (ZeroConstructor)
		unsigned char                                      UnknownData_GS8I[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
	};
	...
	struct FExternalMip
	{
		...
		unsigned char                                      UnknownData_N8JZ[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
	};
	...
	struct FDebugTextInfo
	{
		...
		unsigned char                                      UnknownData_UX6F[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVector                                     OrigActorLocation;                                         // 0x0040(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_PHUM[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_C7P2[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_1C1L[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<struct FPaintedVertex>                      PaintedVertices;                                           // 0x0010(0x0010) (ZeroConstructor)
		unsigned char                                      UnknownData_22GO[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_NKO5[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
	};
	...
	struct FReplicatedTransformState
	{
		...
		unsigned char                                      UnknownData_Y63H[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_0ONJ[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD (NoDestructor)
		unsigned char                                      UnknownData_YLHF[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FDestructibleDamageParameters
	{
		...
		unsigned char                                      UnknownData_SVH9[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_SU8U[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FDestructibleSpecialHierarchyDepths
	{
		...
		unsigned char                                      UnknownData_8EY2[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FDestructibleParametersFlag
	{
		...
		unsigned char                                      UnknownData_JZG9[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
	};
	...
	struct FDestructibleParameters
	{
		...
		unsigned char                                      UnknownData_K7SV[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_KBRQ[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD (NoDestructor)
		unsigned char                                      UnknownData_I9XV[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FMaterialRelevance
	{
		...
		unsigned char                                      UnknownData_131E[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		uint16_t                                           ShadingModelMask;                                          // 0x0004(0x0002) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_O4D9[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_G06B[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_A33Z[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FMaterialInstanceBasePropertyOverrides
	{
		...
		unsigned char                                      UnknownData_L0EM[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_XRZU[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_Q0YY[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_6XQN[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                      ForceResolution : 1;                                       // 0x0028(0x0001) BIT_FIELD (Edit, NoDestructor)
		unsigned char                                      UnknownData_AXVS[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_DKPB[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                      DisableTransition : 1;                                     // 0x0030(0x0001) BIT_FIELD (Edit, NoDestructor)
		unsigned char                                      UnknownData_ONT0[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_H49Q[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_2VWF[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_NK57[0x3];                                     // 0x0079(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FEventGraphFastCallPair
	{
		...
		unsigned char                                      UnknownData_XYRS[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FEdGraphPinType
	{
		...
		unsigned char                                      UnknownData_9Q9Y[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FFOscillator
	{
		...
		unsigned char                                      UnknownData_F1Y7[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FMergedCollisionComponentStaticMeshInstanceData
	{
		...
		unsigned char                                      UnknownData_VP1O[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FLayerActorStats
	{
		...
		unsigned char                                      UnknownData_9OZV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FLightmassPrimitiveSettings
	{
		...
		unsigned char                                      UnknownData_DCNH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FEmitterPointData
	{
		...
		unsigned char                                      UnknownData_UEBC[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FParticleSysParam
	{
		...
		unsigned char                                      UnknownData_O8KV[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAudioComponentParam
	{
		...
		unsigned char                                      UnknownData_37QC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int                                                IntParam;                                                  // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_JLQT[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FLightmassLightSettings
	{
		...
		unsigned char                                      UnknownData_SD68[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FNavGraphNode
	{
		...
		unsigned char                                      UnknownData_LJ09[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
	};
	...
	struct FFFTWaterComponentWaveParticleType
	{
		...
		unsigned char                                      UnknownData_UAUM[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FFFTWaterComponentIntersectParticleType
	{
		...
		unsigned char                                      UnknownData_0RP5[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FMurkyRegion
	{
		...
		unsigned char                                      UnknownData_BYN1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_8PXK[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FMaterialSpriteElement
	{
		...
		unsigned char                                      UnknownData_JCDP[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_S6G1[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FCollisionResponseTemplate
	{
		...
		unsigned char                                      UnknownData_ZQ83[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FName                                       ObjectTypeName;                                            // 0x000C(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_EXFH[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_H3TQ[0x27];                                    // 0x0039(0x0027) MISSED OFFSET (PADDING)
	};
	...
	struct FCustomChannelSetup
	{
		...
		unsigned char                                      UnknownData_PLDJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_BS1Z[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (PADDING)
	};
	...
	struct FBlendSample
	{
		...
		unsigned char                                      UnknownData_L452[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FFontParameterValue
	{
		...
		unsigned char                                      UnknownData_NXTE[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FInputAxisProperties
	{
		...
		unsigned char                                      UnknownData_LXNW[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FFontCharacter
	{
		...
		unsigned char                                      UnknownData_WDBT[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FForceFeedbackChannelDetails
	{
		...
		unsigned char                                      UnknownData_DMAB[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FNavigationFilterArea
	{
		...
		unsigned char                                      UnknownData_R8NI[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FNavigationFilterFlags
	{
		...
		unsigned char                                      UnknownData_SZ0N[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
	};
	...
	struct FSupportedAreaData
	{
		...
		unsigned char                                      UnknownData_HA0S[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FSimplygonMaterialLODSettings
	{
		...
		unsigned char                                      UnknownData_GJR2[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_FVZJ[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_RJ2V[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FSkeletalMeshOptimizationSettings
	{
		...
		unsigned char                                      UnknownData_643A[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_NRR6[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_0FNH[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_9VBR[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_GSI4[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_6GLH[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FBlueprintInputDelegateBinding
	{
		...
		unsigned char                                      UnknownData_WVZC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_JRSS[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_A3ZS[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FName                                       FunctionNameToBind;                                        // 0x0034(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_ML6W[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FPhysicalSurfaceName
	{
		...
		unsigned char                                      UnknownData_MH0F[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FName                                       Name;                                                      // 0x0004(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	struct FDominanceGroupPair
	{
		...
		unsigned char                                      UnknownData_OQMO[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FDominanceGroupName
	{
		...
		unsigned char                                      UnknownData_A7RC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FName                                       Name;                                                      // 0x0004(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	struct FTextureLODGroup
	{
		...
		unsigned char                                      UnknownData_BJS1[0xB];                                     // 0x0001(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int                                                LODBias;                                                   // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_4KKK[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_G6HJ[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FVelocityConeGroupParams
	{
		...
		unsigned char                                      UnknownData_2F31[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
		bool                                               bActive;                                                   // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_I1QA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_6J2T[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_TIPK[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_BV67[0x5];                                     // 0x0023(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FSkeletalMeshLODInfo
	{
		...
		unsigned char                                      UnknownData_GUSX[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_MTPK[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_JQG4[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_UXID[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_4U64[0x1];                                     // 0x008B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_YVV3[0x3];                                     // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ZQSH[0x3];                                     // 0x009D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_F53D[0x1];                                     // 0x00A7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_D0I4[0x3];                                     // 0x00A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_20QW[0x3];                                     // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ABL8[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_DIN5[0xA];                                     // 0x0106(0x000A) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_S28I[0x3];                                     // 0x0121(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_P4VZ[0x18];                                    // 0x0148(0x0018) MISSED OFFSET (PADDING)
	};
	...
	struct FBlueprintInputActionDelegateBinding : public FBlueprintInputDelegateBinding
	{
		...
		unsigned char                                      UnknownData_AQIN[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FName                                       FunctionNameToBind;                                        // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	struct FRigTransformConstraint
	{
		...
		unsigned char                                      UnknownData_7VS4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FNode
	{
		...
		unsigned char                                      UnknownData_6AAZ[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
	};
	...
	struct FInterpControlPoint
	{
		...
		unsigned char                                      UnknownData_3W7W[0xF];                                     // 0x000D(0x000F) MISSED OFFSET (PADDING)
	};
	...
	struct FGPUSpriteResourceData
	{
		...
		unsigned char                                      UnknownData_AMD7[0x1];                                     // 0x020B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVector2D                                   PivotOffset;                                               // 0x020C(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_M739[0x3C4];                                   // 0x0214(0x03C4) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              AlignmentInheritedVelocityScale;                           // 0x05D8(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_9PR6[0x194];                                   // 0x05DC(0x0194) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_OQEV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_JOFZ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_LE5Q[0x140];                                   // 0x0000(0x0140) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_6GVL[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_BIVE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_DIPB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_4EHD[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
	};
	...
	struct FFFTWaterComponentParticleParams
	{
		...
		unsigned char                                      UnknownData_MO0H[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FFFTWaterComponentParams
	{
		...
		unsigned char                                      UnknownData_PXW7[0x3];                                     // 0x0079(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_4EQY[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FEngineShowFlagsSetting
	{
		...
		unsigned char                                      UnknownData_Z5LE[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FTimelineVectorTrack
	{
		...
		unsigned char                                      UnknownData_SHLM[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FTimelineFloatTrack
	{
		...
		unsigned char                                      UnknownData_KZGP[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FTimelineLinearColorTrack
	{
		...
		unsigned char                                      UnknownData_Q7N4[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FTimeline
	{
		...
		unsigned char                                      UnknownData_IR0M[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_JSYL[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ZRX1[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_K732[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FCompressedOffsetData
	{
		...
		unsigned char                                      UnknownData_BQKQ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FBlendParameter
	{
		...
		unsigned char                                      UnknownData_OM62[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FInterpolationParameter
	{
		...
		unsigned char                                      UnknownData_6XDH[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FBlendSampleData
	{
		...
		float                                              Time;                                                      // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_EI5W[0x14];                                    // 0x000C(0x0014) MISSED OFFSET (PADDING)
	};
	...
	struct FBlendFilter
	{
		unsigned char                                      UnknownData_F93H[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
	};
	...
	struct FOpenTestAsset
	{
		...
		unsigned char                                      UnknownData_QG7P[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FTextureRenderData
	{
		...
		unsigned char                                      UnknownData_WPFI[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FMaterialSimplificationSettings
	{
		...
		unsigned char                                      UnknownData_H8OC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_VYTU[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_C7E2[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_AEIF[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FMeshProxySettings
	{
		...
		unsigned char                                      UnknownData_BYZS[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ESRW[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ZS5S[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FPresortedBillboardsParams
	{
		...
		unsigned char                                      UnknownData_7Y03[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FMeshBuildSettings
	{
		...
		unsigned char                                      UnknownData_1942[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_D93F[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FMeshReductionSettings
	{
		...
		unsigned char                                      UnknownData_1U1M[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_H4LX[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FSimplygonMaterialLODSettings               MaterialLODSettings;                                       // 0x0028(0x0028) (Edit)
		...
		unsigned char                                      UnknownData_G97G[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_CLPO[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_DYR5[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_YOXD[0x4];                                     // 0x0018(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int                                                BaseNonRenderedUpdateRate;                                 // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_5TVE[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FOverlapResult
	{
		...
		unsigned char                                      UnknownData_J3KF[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                      bBlockingHit : 1;                                          // 0x0014(0x0001) BIT_FIELD (NoDestructor)
		unsigned char                                      UnknownData_OQ8M[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FSwarmDebugOptions
	{
		...
		unsigned char                                      UnknownData_YP9D[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FLightmassDebugOptions
	{
		...
		unsigned char                                      UnknownData_T9KZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_XM97[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FEditorMapPerformanceTestDefinition
	{
		...
		unsigned char                                      UnknownData_N1C6[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FSubtitleCue
	{
		...
		unsigned char                                      UnknownData_FF7M[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		float                                              Time;                                                      // 0x0038(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_RSF7[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FLocalizedSubtitle
	{
		...
		unsigned char                                      UnknownData_J1PP[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FSoundClassProperties
	{
		...
		unsigned char                                      UnknownData_MWTR[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_QH31[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_4ZET[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_D4YL[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FSoundClassAdjuster
	{
		...
		unsigned char                                      UnknownData_UCFV[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FModulatorContinuousParams
	{
		...
		unsigned char                                      UnknownData_G9B8[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FTTTrackBase
	{
		...
		unsigned char                                      UnknownData_NFKS[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_DZMV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_ZLMZ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_IQNA[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_VWTA[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FEditorImportExportTestDefinition
	{
		...
		unsigned char                                      UnknownData_0B50[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FBakedAnimationState
	{
		...
		unsigned char                                      UnknownData_XC7X[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_A3Z5[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FBakedAnimationStateMachine
	{
		...
		unsigned char                                      UnknownData_S93O[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FBlueprintInputTouchDelegateBinding : public FBlueprintInputDelegateBinding
	{
		...
		unsigned char                                      UnknownData_64H9[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FFontImportOptionsData
	{
		...
		unsigned char                                      UnknownData_5K4C[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_JYX2[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_UT79[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_CFXQ[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_1MTA[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_R5YB[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_A4RG[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FEmitterDynamicParameter
	{
		...
		unsigned char                                      UnknownData_W3UL[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_KPOT[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                      bScaleVelocityByParamValue : 1;                            // 0x0010(0x0001) BIT_FIELD (Edit, NoDestructor)
		unsigned char                                      UnknownData_NR50[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FStringCurveKey
	{
		...
		unsigned char                                      UnknownData_HOPI[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FExposureSettings
	{
		...
		unsigned char                                      UnknownData_OYMP[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FURL
	{
		...
		unsigned char                                      UnknownData_6I00[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_GFB8[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_KGBQ[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
	};
	...
	struct FDepthFieldGlowInfo
	{
		...
		unsigned char                                      UnknownData_H9DR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FFontRenderInfo
	{
		...
		unsigned char                                      UnknownData_9UV5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FComponentReference
	{
		...
		unsigned char                                      UnknownData_ZJSH[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FDamageEvent
	{
		unsigned char                                      UnknownData_00FV[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_NTXF[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	struct FMeshMergingSettings
	{
		...
		unsigned char                                      UnknownData_KJC8[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_89FK[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNotifyTrack
	{
		...
		unsigned char                                      UnknownData_9IB8[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_DVRI[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FAlphaBlend
	{
		...
		unsigned char                                      UnknownData_SPYF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_YF4T[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimationTransitionRule
	{
		...
		unsigned char                                      UnknownData_L32N[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FSlotEvaluationPose
	{
		...
		unsigned char                                      UnknownData_8HGZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              Weight;                                                    // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_1Z2V[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_Y7C6[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
	};
	...
	struct FIntegralCurve : public FIndexedCurve
	{
		...
		unsigned char                                      UnknownData_WOO7[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_SU8K[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_GKAK[0x6A];                                    // 0x0000(0x006A) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_3HU0[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_D7M4[0xC0];                                    // 0x0000(0x00C0) MISSED OFFSET (PADDING)
	};
	...
	struct FServerMigrationTelemetryActorData
	{
		...
		unsigned char                                      UnknownData_ZHGV[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                      UnknownData_BCO6[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FReplicatedPhysicsState
	{
		...
		unsigned char                                      UnknownData_AA7O[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
	};
	...
	{
		struct FVector                                     Center;                                                    // 0x0020(0x000C) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_N0RM[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_12IC[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
		struct FVector                                     Center;                                                    // 0x0020(0x000C) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_84WJ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FQuat                                       Orientation;                                               // 0x0030(0x0010) (Edit, EditConst, IsPlainOldData, NoDestructor)
		...
		unsigned char                                      UnknownData_EE66[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FKConvexElem : public FKShapeElem
	{
		...
		unsigned char                                      UnknownData_C7OZ[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FTransform                                  Transform;                                                 // 0x0050(0x0030) (IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_A8WH[0x10];                                    // 0x0080(0x0010) MISSED OFFSET (PADDING)
	};
	...
	struct FKAggregateGeom
	{
		...
		unsigned char                                      UnknownData_J30A[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_SFXK[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		TEnumAsByte<Engine_EParticleEventType>             Type;                                                      // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_I1N3[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int                                                Frequency;                                                 // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		...
		unsigned char                                      UnknownData_O8IR[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FPlatformInterfaceData
	{
		...
		unsigned char                                      UnknownData_PCXG[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_UKH4[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FKeyBind
	{
		...
		unsigned char                                      UnknownData_L158[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FInputActionKeyMapping
	{
		...
		unsigned char                                      UnknownData_EBGP[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FCurveEdEntry
	{
		...
		unsigned char                                      UnknownData_TN2C[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FBoolTrackKey
	{
		...
		unsigned char                                      UnknownData_S3F0[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimControlTrackKey
	{
		...
		unsigned char                                      UnknownData_GZX5[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_N7R4[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FToggleTrackKey
	{
		...
		unsigned char                                      UnknownData_XVWZ[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FSoundTrackKey
	{
		...
		unsigned char                                      UnknownData_22RN[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FVisibilityTrackKey
	{
		...
		unsigned char                                      UnknownData_XZSV[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
	};
	...
	struct FPrimitiveMaterialRef
	{
		...
		unsigned char                                      UnknownData_J5SR[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FHIKBoneTransform
	{
		...
		unsigned char                                      UnknownData_WKBK[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAssetEditorOrbitCameraPosition
	{
		...
		unsigned char                                      UnknownData_6GNF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_MVDU[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
	};
	...
	struct FMeshSectionInfo
	{
		...
		unsigned char                                      UnknownData_K9JE[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
	};
	...
	struct FStaticMeshOptimizationSettings
	{
		...
		unsigned char                                      UnknownData_4WEV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              NumOfTrianglesPercentage;                                  // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		float                                              MaxDeviationPercentage;                                    // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		float                                              WeldingThreshold;                                          // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		bool                                               bRecalcNormals;                                            // 0x0010(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_SKRN[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              NormalsThreshold;                                          // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		...
		unsigned char                                      UnknownData_MBAV[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_WJF6[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_7IJ3[0x80];                                    // 0x0000(0x0080) MISSED OFFSET (PADDING)
	};
	...
	struct FInputAxisKeyMapping
	{
		...
		unsigned char                                      UnknownData_WNXL[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FParticleRandomSeedInfo
	{
		...
		unsigned char                                      UnknownData_ULSK[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_IKBC[0xA8];                                    // 0x0000(0x00A8) MISSED OFFSET (PADDING)
	};
	...
	struct FGPUSpriteLocalVectorFieldInfo
	{
		...
		unsigned char                                      UnknownData_R1XM[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (IsPlainOldData, NoDestructor)
		...
		unsigned char                                      UnknownData_C5HW[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FGPUSpriteEmitterInfo
	{
		...
		unsigned char                                      UnknownData_S1GQ[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_VAF2[0x1];                                     // 0x0187(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_8JWQ[0x3];                                     // 0x0189(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ZNM7[0x3];                                     // 0x018D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_6O5O[0x17];                                    // 0x0289(0x0017) MISSED OFFSET (PADDING)
	};
	...
	struct FRigidBodyContactInfo
	{
		...
		unsigned char                                      UnknownData_ACAM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FRigidBodyState
	{
		...
		unsigned char                                      UnknownData_TANX[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_D52U[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FEditedDocumentInfo
	{
		...
		unsigned char                                      UnknownData_Z4M9[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FBPVariableDescription
	{
		...
		unsigned char                                      UnknownData_2DGS[0x20];                                    // 0x0078(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FMemberReference
	{
		...
		unsigned char                                      UnknownData_65X5[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_XZ58[0xF0];                                    // 0x0000(0x00F0) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_QAWG[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_21VX[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_XD4W[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_IJCO[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FLevelViewportInfo
	{
		...
		unsigned char                                      UnknownData_9JC6[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FLevelSimplificationDetails
	{
		...
		unsigned char                                      UnknownData_LB59[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_SH8H[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_9YYV[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_2RKE[0x2];                                     // 0x00AA(0x0002) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_PX4G[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_4T02[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_624N[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FMergedCollisionActorsSimplification
	{
		...
		unsigned char                                      UnknownData_DI6O[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FHierarchicalSimplification
	{
		...
		unsigned char                                      UnknownData_3OY9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_OI41[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_P6B2[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
	};
	...
	struct FSpriteCategoryInfo
	{
		...
		unsigned char                                      UnknownData_MUTR[0x20];                                    // 0x0008(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		struct FText                                       Description;                                               // 0x0040(0x0018) ELEMENT_SIZE_MISMATCH
		unsigned char                                      UnknownData_Y0ST[0x20];                                    // 0x0040(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	};
	...
	struct FTriMeshCollisionData
	{
		...
		unsigned char                                      UnknownData_V592[0x17];                                    // 0x0021(0x0017) MISSED OFFSET (PADDING)
	};
	...
	struct FPreviewAttachedObjectPair
	{
		...
		unsigned char                                      UnknownData_8INQ[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	{
		unsigned char                                      UnknownData_ZK6P[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FText                                       MenuDescription;                                           // 0x0008(0x0018) ELEMENT_SIZE_MISMATCH
		unsigned char                                      UnknownData_M10J[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                      UnknownData_OWAH[0x20];                                    // 0x0050(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		struct FText                                       Keywords;                                                  // 0x0088(0x0018) ELEMENT_SIZE_MISMATCH
		unsigned char                                      UnknownData_0P23[0x20];                                    // 0x0088(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FScreenMessageString
	{
		...
		unsigned char                                      UnknownData_ZAKW[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FFullyLoadedPackagesInfo
	{
		...
		unsigned char                                      UnknownData_3S9P[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FLevelStreamingStatus
	{
		...
		unsigned char                                      UnknownData_8R7J[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FNamedNetDriver
	{
		...
		unsigned char                                      UnknownData_F1XA[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_GAAW[0xE0];                                    // 0x0000(0x00E0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_9IRH[0x10];                                    // 0x01D8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                           // 0x01E8(0x0010) (ZeroConstructor)
		unsigned char                                      UnknownData_552Z[0x18];                                    // 0x01F8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_GJXQ[0x48];                                    // 0x0250(0x0048) MISSED OFFSET (PADDING)
	};
	...
	struct FActiveHapticFeedbackEffect
	{
		...
		unsigned char                                      UnknownData_EH2M[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FHIKElements
	{
		unsigned char                                      UnknownData_PDW2[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
	};
	...
	struct FSubTrackGroup
	{
		...
		unsigned char                                      UnknownData_TL36[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FSupportedSubTrackInfo
	{
		...
		unsigned char                                      UnknownData_PW1D[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FClientReceiveData
	{
		...
		unsigned char                                      UnknownData_TDRB[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_FVDM[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_87QB[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_CZ5B[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_AHSJ[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_AFYL[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimationRecordingSettings
	{
		...
		unsigned char                                      UnknownData_5MY1[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimNode_ApplyAdditive : public FAnimNode_Base
	{
		...
		float                                              Alpha;                                                     // 0x0060(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		struct FInputScaleBias                             AlphaScaleBias;                                            // 0x0064(0x0008) (Edit, BlueprintVisible)
		unsigned char                                      UnknownData_U4BR[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_BlendListBase : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_RHFW[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_8YAU[0x14];                                    // 0x0094(0x0014) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_BlendListByBool : public FAnimNode_BlendListBase
	{
		...
		unsigned char                                      UnknownData_QLHZ[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_BlendListByEnum : public FAnimNode_BlendListBase
	{
		...
		unsigned char                                      UnknownData_ADR1[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_BlendListByInt : public FAnimNode_BlendListBase
	{
		...
		unsigned char                                      UnknownData_LIZP[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
	{
		...
		unsigned char                                      UnknownData_9SB8[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_OHCI[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ITJM[0x8];                                     // 0x0108(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_BlendSpaceEvaluator : public FAnimNode_BlendSpacePlayer
	{
		...
		unsigned char                                      UnknownData_YOT3[0x4];                                     // 0x0114(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKFloorContact : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_IM2I[0x2];                                     // 0x004E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_5XPW[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKLookAt : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_U8Z1[0x2];                                     // 0x005E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_SM4I[0x17];                                    // 0x0071(0x0017) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKOffset : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_S0WP[0x2];                                     // 0x005E(0x0002) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKPin : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_J8RR[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKPlant : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_8KS8[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_QQTM[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKPull : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_DPNQ[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKReach : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_SKZ5[0x2];                                     // 0x0072(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_ZA38[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKReachRotator : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_2DHF[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKRelativePlant : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_HT97[0x8];                                     // 0x0090(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKResist : public FAnimNode_HIKBase
	{
		float                                              Alpha;                                                     // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		TEnumAsByte<Engine_EHIKEffector>                   Effector;                                                  // 0x004C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_5L2I[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKSetProperty : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_352B[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		float                                              Alpha;                                                     // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_GKMG[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_IW23[0x5];                                     // 0x007B(0x0005) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_HIKTest : public FAnimNode_HIKBase
	{
		...
		unsigned char                                      UnknownData_CN16[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_RWGG[0x26];                                    // 0x007A(0x0026) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_MultiWayBlend : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_H21R[0x2];                                     // 0x0052(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FInputScaleBias                             AlphaScaleBias;                                            // 0x0054(0x0008) (Edit, BlueprintVisible)
		unsigned char                                      UnknownData_1AQS[0x14];                                    // 0x005C(0x0014) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_RefPose : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_3AYS[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimNode_RotateRootBone : public FAnimNode_Base
	{
		...
		unsigned char                                      UnknownData_D6UU[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FBoneMirrorExport
	{
		...
		unsigned char                                      UnknownData_8DOZ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimationGroupReference
	{
		...
		unsigned char                                      UnknownData_SXSH[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FAnimExtractContext
	{
		...
		unsigned char                                      UnknownData_HDDC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_4GKX[0x68];                                    // 0x0000(0x0068) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_UG7I[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_ZOEB[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FAnimMontageInstance
	{
		...
		unsigned char                                      UnknownData_NRT9[0x2F];                                    // 0x0039(0x002F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_3NX2[0x20];                                    // 0x0080(0x0020) MISSED OFFSET (PADDING)
	};
	...
	struct FFogVolumeInfo
	{
		...
		unsigned char                                      UnknownData_FAMY[0xF8];                                    // 0x0008(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_30XN[0x20];                                    // 0x0110(0x0020) MISSED OFFSET (PADDING)
	};
	...
	struct FWaterSimPlane
	{
		...
		unsigned char                                      UnknownData_0CDM[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_N3SV[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FBatchedPoint
	{
		...
		unsigned char                                      UnknownData_8LF6[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FBatchedLine
	{
		...
		unsigned char                                      UnknownData_25QP[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (PADDING)
	};
}
