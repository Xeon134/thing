...
namespace CG
{
	...
	struct FSlateColor
	{
		...
		unsigned char                                      UnknownData_QN7Y[0x1F];                                    // 0x0011(0x001F) MISSED OFFSET (PADDING)
	};
	...
	struct FSlateBrush
	{
		...
		unsigned char                                      UnknownData_LZFX[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_T9V1[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_6LYO[0x5];                                     // 0x0063(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_N6CD[0x2];                                     // 0x007A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FInputEvent
	{
		unsigned char                                      UnknownData_ZQOU[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_QPL3[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
	};
	...
	struct FGeometry
	{
		unsigned char                                      UnknownData_ZUL5[0x34];                                    // 0x0000(0x0034) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_L1JP[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FSlateSound
	{
		...
		unsigned char                                      UnknownData_P86Y[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
	};
	...
	struct FSlateFontInfo
	{
		...
		unsigned char                                      UnknownData_3V2T[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_9Q42[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FFontData
	{
		...
		unsigned char                                      UnknownData_YJHL[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FCompositeSubFont
	{
		...
		unsigned char                                      UnknownData_2XWY[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FCompositeFont
	{
		...
		unsigned char                                      UnknownData_Z49Z[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FDockTabStyle : public FSlateWidgetStyle
	{
		...
		unsigned char                                      UnknownData_PD27[0x4];                                     // 0x06B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FInlineTextImageStyle : public FSlateWidgetStyle
	{
		...
		unsigned char                                      UnknownData_5DN6[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (PADDING)
	};
	...
	struct FSearchBoxStyle : public FSlateWidgetStyle
	{
		...
		unsigned char                                      UnknownData_MES5[0x7];                                     // 0x0AF9(0x0007) MISSED OFFSET (PADDING)
	};
	...
	struct FCheckBoxStyle : public FSlateWidgetStyle
	{
		...
		unsigned char                                      UnknownData_D72H[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		unsigned char                                      UnknownData_P50P[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_0LNI[0x30];                                    // 0x0028(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_JILI[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_BXRK[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_A3S2[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_52GL[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FFocusEvent
	{
		unsigned char                                      UnknownData_00JQ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	};
}
