...
namespace CG
{
	...
	struct FBox
	{
		...
		unsigned char                                      UnknownData_6EGG[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FBox2D
	{
		...
		unsigned char                                      UnknownData_1ODV[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FInterpCurvePointFloat
	{
		...
		unsigned char                                      UnknownData_LFUV[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FInterpCurveFloat
	{
		...
		unsigned char                                      UnknownData_VCYK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FInterpCurvePointVector2D
	{
		...
		unsigned char                                      UnknownData_SS4F[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FInterpCurveVector2D
	{
		...
		unsigned char                                      UnknownData_TSOC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FInterpCurvePointVector
	{
		...
		unsigned char                                      UnknownData_TLK6[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FInterpCurveVector
	{
		...
		bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_HEL9[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	{
		float                                              InVal;                                                     // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_UKIU[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                      UnknownData_UH2P[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (PADDING)
	};
	...
	struct FInterpCurveQuat
	{
		...
		bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_CSCX[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	struct FInterpCurvePointTwoVectors
	{
		...
		unsigned char                                      UnknownData_EAIG[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FInterpCurveTwoVectors
	{
		...
		bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_EZAR[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	struct FInterpCurvePointLinearColor
	{
		...
		unsigned char                                      UnknownData_AOS2[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
	};
	...
	struct FInterpCurveLinearColor
	{
		...
		bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_NN51[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	struct FTransform
	{
		...
		unsigned char                                      UnknownData_JVEZ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVector                                     Scale3D;                                                   // 0x0020(0x000C) (Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor)
		unsigned char                                      UnknownData_S52A[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	struct FDateTime
	{
		unsigned char                                      UnknownData_E5YL[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	};
	...
	struct FTimespan
	{
		unsigned char                                      UnknownData_KHJK[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
	};
	...
	{
		unsigned char                                      UnknownData_0N57[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
	...
	struct FFloatRangeBound
	{
		...
		unsigned char                                      UnknownData_45SA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		TEnumAsByte<CoreUObject_ERangeBoundTypes>          Type;                                                      // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                      UnknownData_X7VN[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
